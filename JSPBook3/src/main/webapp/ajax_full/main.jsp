...
<body>
	...
	<div class="container">
	    ...
	    <div class="row">
	    	<button class="btn btn-primary float-right" type="button" id="button-addon2" onClick='javascript:insertData();' >입력</button>
		    <button class="btn btn-primary float-right" type="button" id="button-addon2" onClick='javascript:updateData();' >수정</button>
	    </div>
	    <div class="row">	        
	        <div class="col-xl-6">   
